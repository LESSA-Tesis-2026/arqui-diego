...
def capture_images(letter, target_images=200, delay_seconds=0.1):
    ...
    while current_idx < target_images:
        ...
        cv2.putText(display_frame, f"Letra: {letter} | Capturas: {current_idx}/{target_images}", 
                    (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
        
        if recording:
            cv2.putText(display_frame, "CAPTURANDO... (Mueve la mano ligeramente)", (10, 70), 
            ...
            cv2.putText(display_frame, "Presiona 'r' para iniciar auto-captura", (10, 70), 
